...
public class HubTracker {
    ...
    public static boolean isAllianceAboutToSwitch() {
        ...
        if ((currentTime < 130 && currentTime > 127) || (currentTime > 27 && currentTime < 30)) {
            return true;
        }
        else if ((currentTime > 102 && currentTime < 105) || (currentTime > 77 && currentTime < 80) || (currentTime < 55 && currentTime > 52)) {
            return true;
        }
        else {
            return false;
    ...
    public static boolean areBothAlliancesActive() {
