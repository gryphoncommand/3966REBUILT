...
public class PositionPIDCommand extends Command{
    ...
    private PositionPIDCommand(DriveIO drivetrain, Pose2d goalPose) {
        this.drivetrain = drivetrain;
        this.goalPose = goalPose;
        addRequirements(drivetrain);
    }

    public static Command generateCommand(DriveIO swerve, Pose2d goalPose, Time timeout){
