...
public class ShootAllInHopper extends Command {
     ...
     */
    public ShootAllInHopper(DriveIO driveData, FlywheelIO flywheel, Kicker kicker, PreIndexer preIndexer, IntakeDeployIO intake, boolean stopFlywheelOnEnd, boolean neeedAlign) {
     ...
     */
    public ShootAllInHopper(DriveIO driveData, FlywheelIO flywheel, Kicker kicker, PreIndexer preIndexer, IntakeDeployIO intake) {
        this(driveData, flywheel, kicker, preIndexer, intake, false, true);
    }
